...
def set_sample():
    doc_en = open("../model_en.txt", 'w', encoding='utf-8')
    doc_na = open("../model_na.txt", 'w', encoding='utf-8')
    ...
    for dir_i in dir_list:
        path = '../sample/'
        name = re.findall(r'(\w+)\.', dir_i)[0]
        file_name = path + dir_i
    ...
    print("获取sample完成！")
    print(known_face_encodings, file=doc_en)
    print(known_face_names, file=doc_na)
    return known_face_encodings, known_face_names


# def get_sample():
#     doc_en = open("../model_en.txt", 'r', encoding='utf-8')
#     doc_na = open("../model_na.txt", 'r', encoding='utf-8')
#
#     known_face_encodings = json.loads(doc_en.read())
#     known_face_names = json.loads(doc_na.read())
#
#     return known_face_encodings, known_face_names
...
if __name__ == '__main__':
    ...
    # 获取sample
    known_encodings, known_names = set_sample()
